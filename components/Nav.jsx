...
const Nav = () => {
  return (
    <div className="w-full bg-[#b4bdbc]">
    <div className="w-full mx-auto flex justify-normal items-start">
      <div className="w-[10%] border-x-[1.8px] border-[#aeb7b6] h-[9vh]"></div>
      ...
      <div className="w-[90%] flex justify-normal items-start">
        ...
        <div className='absolute top-0 left-0 w-full h-full flex justify-around items-center font-["pacifico"] mt-[.9rem]'>
      ...
      <div className="w-[10%] border-x-[1.8px] border-[#aeb7b6] h-[9vh]">
